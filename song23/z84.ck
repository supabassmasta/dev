class SUPERSAW_WRONG extends SYNT{
...
TONE t;
t.reg(SUPERSAW_WRONG s1);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();//
...
STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 4 /* Q */, 100 /* f_base */ , 200  /* f_var */, 1::second / (9 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
