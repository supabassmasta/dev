...
flang.add_line(0 /* 0 : left, 1: right 2: both */, .4 /* delay line gain */,  6::ms /* dur base */, 1::ms /* dur range */, 91 /* freq */);
flang.add_line(1 /* 0 : left, 1: right 2: both */, .4 /* delay line gain */,  6::ms /* dur base */, 1::ms /* dur range */, 93 /* freq */);
...
//STLPF lpf;
//lpf.connect(last $ ST , 1000 /* freq */  , 3.0 /* Q */  );       lpf $ ST @=>  last; 

STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 4 /* Q */, 360 /* f_base */ , 3400  /* f_var */, 1::second / (16 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
...
STGVERB stgverb;
stgverb.connect(last $ ST, .3 /* mix */, 4 * 10. /* room size */, 2::second /* rev time */, 0.1 /* early */ , 0.3 /* tail */ ); stgverb $ ST @=>  last; 
