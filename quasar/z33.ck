...
STLPF lpf;
lpf.connect(last $ ST , 20 *100 /* freq */  , 1.3 /* Q */  );       lpf $ ST @=>  last; 

STECHO ech;
ech.connect(last $ ST , data.tick * 3 / 4 + 10::ms, .7);  ech $ ST @=>  last; 

STGVERB stgverb;
stgverb.connect(last $ ST, .9 /* mix */, 9 * 10. /* room size */, 7::second /* rev time */, 0.6 /* early */ , 0.9 /* tail */ ); stgverb $ ST @=>  last; 
