...
STLPF lpf;
lpf.connect(last $ ST , 400 /* freq */  , 3.0 /* Q */  );       lpf $ ST @=>  last; 

//STFILTERMOD fmod;
//fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 3 /* Q */, 150 /* f_base */ , 400  /* f_var */, 1::second / (7 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
