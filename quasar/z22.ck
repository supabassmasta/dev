...
flang.add_line(2 /* 0 : left, 1: right 2: both */, .8 /* delay line gain */,  3::ms /* dur base */, 1::ms /* dur range */, 1::second / (16 * data.tick) /* freq */); 
//flang.add_line(2 /* 0 : left, 1: right 2: both */, .4 /* delay line gain */,  3::ms /* dur base */, 1::ms /* dur range */, 1::second / (8 * data.tick) + .1/* freq */); 
//
//STLPF lpf;
//lpf.connect(last $ ST , 2 * 100 /* freq */  , 1.0 /* Q */  );       lpf $ ST @=>  last; 

STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 3 /* Q */, 100 /* f_base */ , 200  /* f_var */, 1::second / (8 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
