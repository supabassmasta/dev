TONE t;
t.reg(PLOC3 s0);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// t.dor();// t.aeo(); // t.phr();// t.loc();
...
STEPC stepc1; stepc1.init(HW.lpd8.potar[1][6], .1 /* min */, 30 /* max */, 50::ms /* transition_dur */);
...
STGAINC gainc;
gainc.connect(last $ ST , HW.lpd8.potar[1][7] /* gain */  , 1. /* static gain */  );       gainc $ ST @=>  last; 
