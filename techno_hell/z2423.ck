...
0::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();//s0.config(nb /* synt nb */ ); 
...
t.set_adsrs(2::ms, 40::ms, .6, 400::ms);
...
STAUTOPAN autopan;
autopan.connect(last $ ST, .4 /* span 0..1 */, data.tick * 8 / 1 /* period */, 0.95 /* phase 0..1 */ );       autopan $ ST @=>  last; 
...
while(1) {
  spork ~   NIAP ("{c{c _1|2|3__ ____", 21 /*synt_nb  */, 200::ms /* decay_dur */, 2.0 /* decay_curve */,  .15 /* gain */);
8 * data.tick =>  w.wait; 
  spork ~   NIAP (" _1|2|3__ ____", 18 /*synt_nb  */, 200::ms /* decay_dur */, 2.0 /* decay_curve */,  .3 /* gain */);
8 * data.tick =>  w.wait; 
  spork ~   NIAP ("}c _1|2|3__ ____", 8 /*synt_nb  */, 200::ms /* decay_dur */, 2.0 /* decay_curve */,  .21 /* gain */);
8 * data.tick =>  w.wait; 
