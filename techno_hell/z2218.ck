...
"../_SAMPLES/monkey/monkey1.wav" => s.wav["a"];  // act @=> s.action["a"]; 
"../_SAMPLES/kukabura/kuka3.wav" => s.wav["b"];// _ = pause , ~ = special pause , | = add note to current , * : =
"../_SAMPLES/parrot/parrot1.wav" => s.wav["c"];// mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = rate , ? = proba , $ = autonomous  
"___ ____ ____ __a_
___ ____ ____ __b_
___ ____ ____ __c_
" => s.seq;
