...
fun void  VOICES  (){ 
   WAIT w;
   8 *data.tick => w.fixed_end_dur;
   spork ~   SINGLEWAV("../_SAMPLES/HighMaintenance/AChaqueFois.wav", .4); 
   16 * data.tick =>  w.wait; 
   spork ~   SINGLEWAV("../_SAMPLES/HighMaintenance/EnPrendreCombien.wav", .4); 
   8 * data.tick =>  w.wait; 
   spork ~   SINGLEWAV("../_SAMPLES/HighMaintenance/CaJenSaisRien.wav", .4); 
   8 * data.tick =>  w.wait; 
   ...
   4 * data.tick =>  w.wait; 
   spork ~   SINGLEWAVRATE("../_SAMPLES/HighMaintenance/JpenseQuifautPasAbuser.wav", .6, .4); 
   16 * data.tick =>  w.wait; 
