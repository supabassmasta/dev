...
fun void  SLIDESERUM1  (float fstart, float fstop, dur d, float g){ 
  1 * data.tick => dur attackRelease;
   ...
   s0.add(19 /* synt nb */ , 2 /* rank */ , 0.4 /* GAIN */, 1.0 /* in freq gain */,  0 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */,3* data.tick /* release */ ); 
   s0.add(19 /* synt nb */ , 2 /* rank */ , 0.4 /* GAIN */, 1.001 /* in freq gain */,  0 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */,3* data.tick /* release */ ); 
