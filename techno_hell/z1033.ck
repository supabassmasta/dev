...
" => stcutter.t.seq;
stcutter.connect(last, 1::ms /* attack */, 3::ms /* release */ );   stcutter $ ST @=> last; 

//STDUCK2 duck2;
//duck2.connect(last $ ST, 4. /* Side Chain Gain */, .04 /* Tresh */, .2 /* Slope */, 2::ms /* Attack */, 3::ms /* Release */ );      duck2 $ ST @=>  last;  
while(1) {
       100::ms => now;
}
