...
// fix tuning
1.087 => s.wav_o["b"].wav0.rate;
//2 * 1.087 => s.wav_o["c"].wav0.rate;

STGVERB stgverb;
stgverb.connect(last $ ST, .4 /* mix */, 11 * 10. /* room size */, 8::second /* rev time */, 0.2 /* early */ , 0.2 /* tail */ ); stgverb $ ST @=>  last; 
