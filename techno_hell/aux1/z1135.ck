...
detune.config_aux(0.5 /* detune percentage */, .9 /* aux gain output */ );  


STCUTTER stcutter;
":4 1__11_" => stcutter.t.seq;
stcutter.connect(last,8 *data.tick /* attack */, 8 *data.tick /* release */ );   stcutter $ ST @=> last; 

STGVERB stgverb;
stgverb.connect(last $ ST, .1 /* mix */, 13 * 10. /* room size */, 8::second /* rev time */, 0.4 /* early */ , 0.9 /* tail */ ); stgverb $ ST @=>  last; 
