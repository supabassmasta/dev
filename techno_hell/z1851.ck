...
while(1) {
spork ~   IBNIZ ("4*d2r1A&*", data.tick * 4 /2 , 0.8); 
4 * data.tick =>  w.wait; 
spork ~   IBNIZ ("7*ddd1A&*", data.tick * 1 /2 , 1.8); 
1 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*d2r1C&*", data.tick * 4 /2 , 0.8); 
4 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*ddd1A&*", data.tick * 1 /2 , 1.8); 
2 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*ddd1A&*", data.tick * 1 /2 , 1.8); 
2 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*d31A&*", data.tick * 3 /2 , 1.8); 
4 * data.tick =>  w.wait; 
spork ~   IBNIZ ("2*7*ddd1A&*", data.tick * 1 /2 , 1.8); 
1 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*d3r1A&*", data.tick * 4 /2 , 0.8); 
4 * data.tick =>  w.wait; 
spork ~   IBNIZ ("4*d4r1A&*", data.tick * 4 /2 , 0.8); 
4 * data.tick =>  w.wait; 
}
