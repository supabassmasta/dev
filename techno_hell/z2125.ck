...
s0.add(28 /* synt nb */ , 0 /* rank */ , 0.4 /* GAIN */, 1.0 /* in freq gain */,  2 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, 3* data.tick /* release */ );
...
flang.add_line(2 /* 0 : left, 1: right 2: both */, .3 /* delay line gain */,  15::ms /* dur base */, 12::ms /* dur range */, 21 /* freq */); 


STSYNCFILTERX stsynclpfx0; LPF_XFACTORY stsynclpfx0_fact;
stsynclpfx0.freq(3 * 10 /* Base */, 8 * 100 /* Variable */, 2. /* Q */);
stsynclpfx0.adsr_set(.4 /* Relative Attack */, .2 /* Relative Decay */, .6 /* Sustain */, .2 /* Relative Sustain dur */, 0.5 /* Relative release */);
