...
s0.add(0 /* synt nb */ , 0 /* rank */ , 0.3 /* GAIN */, 1.0 /* in freq gain */,  2::ms /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, 3::ms /* release */ );
s0.add(0 /* synt nb */ , 0 /* rank */ , 0.15 /* GAIN */, 0.5 /* in freq gain */,  2::ms /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, 3::ms /* release */ );
...
1_1_ 11__ 1__8 _11_ __1_ 11_1 _1__ 11__
*21_1_ 1___:2 11__ 1__5 _11_ __1_ 11_1 _1__ *21_1_:21_
...
stsynclpfx0.freq(100 /* Base */, 59 * 100 /* Variable */, 1.3 /* Q */);
...
SinOsc sin0   => adsrmod.in; // CONNECT this /!\ WARNING Modulator Gain to set as ratio of main frequeny example 0.1 
74.0 => sin0.freq;
0.10 => sin0.gain;
...
stlpfx0.connect(last $ ST ,  stlpfx0_fact, 7* 100.0 /* freq */ , 1.0 /* Q */ , 2 /* order */, 1 /* channels */ );       stlpfx0 $ ST @=>  last;  
