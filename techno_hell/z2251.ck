...
stautolpfx0.connect(last $ ST ,  stautolpfx0_fact, 1.0 /* Q */, 16 * 10 /* freq base */, 4 * 100 /* freq var */, data.tick * 12 / 2 /* modulation period */, 3 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautolpfx0 $ ST @=>  last;  
