...
STLPFC2 lpfc2bis;
lpfc2bis.connect(last $ ST , HW.lpd8.potar[1][7] /* freq */  , HW.lpd8.potar[1][8] /* Q */  );       lpfc2bis $ ST @=>  last; 

STGAINC gainc;
gainc.connect(last $ ST , HW.lpd8.potar[1][5] /* gain */  , 1. /* static gain */  );       gainc $ ST @=>  last; 

STHPF hpf;
hpf.connect(last $ ST , 2 * 100 /* freq */  , 1.0 /* Q */  );       hpf $ ST @=>  last; 
...
STGAIN stgain;
stgain.connect(last $ ST , 0.7 /* static gain */  );       stgain $ ST @=>  last; 
