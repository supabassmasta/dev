TONE t;
t.reg(SUPERSAW0 s0);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// t.dor();// t.aeo(); // t.phr();// t.loc();
// _ = pause , | = add note to current , * : = mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = shift base note , ! = force new note , # = sharp , ^ = bemol  
"1111 11__ ____ ____   ____ ____ ____ ____" => t.seq;
...
STSYNCLPF stsynclpf;
stsynclpf.freq(100 /* Base */, 5 * 100 /* Variable */, 4. /* Q */);
