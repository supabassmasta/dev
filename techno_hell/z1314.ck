...
STSYNCLPF stsynclpf;
stsynclpf.freq(10 /* Base */, 12 * 100 /* Variable */, 4. /* Q */);
stsynclpf.adsr_set(.1 /* Relative Attack */, .6/* Relative Decay */, .00001 /* Sustain */, .2 /* Relative Sustain dur */, 0.4 /* Relative release */);
