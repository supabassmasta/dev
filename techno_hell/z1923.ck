...
STGVERB stgverb;
stgverb.connect(last $ ST, .01 /* mix */, 2 * 10. /* room size */, 1::second /* rev time */, 0.2 /* early */ , 0.6 /* tail */ ); stgverb $ ST @=>  last; 
