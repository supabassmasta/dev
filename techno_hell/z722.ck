...
//    
//    STREC strec;
//    strec.connect(last $ ST, 64*data.tick, "../_SAMPLES/techno_hell/pads722.wav", 0 * data.tick /* sync_dur, 0 == sync on full dur */, 0 /* no sync */ ); strec $ ST @=>  last;  

LONG_WAV l;
"../_SAMPLES/techno_hell/pads722.wav" => l.read;
1.0 * data.master_gain => l.buf.gain;
0 => l.update_ref_time;
l.AttackRelease(0::ms,4 * data.tick);
l.start(32 * data.tick /* sync */ , 0 * data.tick  /* offset */ , 64 * data.tick /* loop (0::ms == disable) */ , 4 * data.tick /* END sync */); l $ ST @=> ST @ last;  
