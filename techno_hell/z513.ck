...
"*4 _aaa_a_a_aa__aaa" => s.seq;
.41 * data.master_gain => s.gain; // s.gain("s", .2); // for single wav 
...
STFILTERMOD fmod;
fmod.connect( last , "ResonZ" /* "HPF" "BPF" BRF" "ResonZ" */, 5 /* Q */, 2600 /* f_base */ , 3400  /* f_var */, 1::second / (8 * data.tick + 10::ms) /* f_mod */);     fmod  $ ST @=>  last; 

STECHO ech;
ech.connect(last $ ST , data.tick * 1 / 4 + 10::ms , .4);  ech $ ST @=>  last; 
