...
s0.add(8 /* synt nb */ , 0 /* rank */ , 0.3 /* GAIN */, 1.0 /* in freq gain */,  2::ms /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, 3::ms /* release */ );
...
//1_1_ 1___ 1//1__ 1//1__   1//1!0//0 !3//3!2//2 1///1_ 11///1 
//1_1_ 1___ 1//1__ 1//1__  1_1_ 1_1_ 1//1__ 1//1__
//1_1_ 1___ 1//1__ 1//1__   1//1!5//5 !3//3!2//2 1///1_ 11///1 

" 
}c

____  __ *8 1_1_ __1_ 1//1__ 1//1__ :8
____  __ *8 1_B_ __1_ 1_1_ 1_+6 1_ :8
...
stautohpfx0.connect(last $ ST ,  stautohpfx0_fact, 2.4 /* Q */, 1 * 100 /* freq base */, 7 * 100 /* freq var */, data.tick * 43 / 2 /* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautohpfx0 $ ST @=>  last;  

STGVERB stgverb;
stgverb.connect(last $ ST, 0.1 /* mix */, 4 * 10. /* room size */, 1::second /* rev time */, 0.2 /* early */ , 0.6 /* tail */ ); stgverb $ ST @=>  last; 
