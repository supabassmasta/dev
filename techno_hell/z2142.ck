...
fun void  SLIDESERUM1  (float fstart, float fstop, dur d, float g){ 
  1 * data.tick => dur attackRelease;
   ...
   s0.add(21 /* synt nb */ , 2 /* rank */ , 0.4 /* GAIN */, 1.0 /* in freq gain */,  8 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, attackRelease /* release */ ); 
   s0.add(17 /* synt nb */ , 2 /* rank */ , 0.4 /* GAIN */, 1.0 /* in freq gain */,  0 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */,3* data.tick /* release */ ); 
   s0.add(17 /* synt nb */ , 2 /* rank */ , 0.4 /* GAIN */, 1.001 /* in freq gain */,  0 * data.tick /* attack */, 0 * data.tick /* decay */, 1. /* sustain */,3* data.tick /* release */ ); 
...
8 *data.tick => w.fixed_end_dur;
    ...
    8 * data.tick =>  w.wait; 
LAUNCHPAD_VIRTUAL.off.set(2111);
LAUNCHPAD_VIRTUAL.off.set(2112);
LAUNCHPAD_VIRTUAL.off.set(2121);
LAUNCHPAD_VIRTUAL.off.set(2124);
//LAUNCHPAD_VIRTUAL.off.set(2121);


   spork ~ ACOUSTICTOM("*8 AAAABBBB CCCCDDDD A_B_ C_CD SABC D__U ");
   spork ~  TRANCEBREAK ("____ *8 L___ L_L_ LLLL LLLL*2 LLLL LLLL LLLL LLLL LLLL LLLL LLLL LLLL"); 
   8 * data.tick =>  w.wait; 
   spork ~   SINGLEWAV("../_SAMPLES/Lovecraft/DieToFokMe.wav", .5); 

    4 * data.tick - 1::samp =>  w.wait; 
    spork ~  SLIDESERUM1(20/* fstart */, 3000 /* fstop */, 4* data.tick /* dur */,  .12 /* gain */); 
    
   spork ~ ACOUSTICTOM("__ *4 ABCD :4 *4 +2U+2A+2B+2C ");
//   spork ~ ACOUSTICTOM_EFFECT("___ *6 ___ __U ");
//   spork ~ ACOUSTICTOM_EFFECT(" ____ *2 _U ");
    4 * data.tick - 1::samp =>  w.wait; 
LAUNCHPAD_VIRTUAL.on.set(2111);
.25 * data.tick =>  w.wait;
LAUNCHPAD_VIRTUAL.on.set(2112);
LAUNCHPAD_VIRTUAL.on.set(2124);
   8 * data.tick =>  w.wait; 
LAUNCHPAD_VIRTUAL.off.set(2142); // AUTOOFF
   8 * data.tick =>  w.wait; 
