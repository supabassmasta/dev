...
"../../_SAMPLES/Aborigines/aboscream0.wav" => s.wav["b"];
"../../_SAMPLES/Aborigines/aboscream1.wav" => s.wav["d"];
"../../_SAMPLES/Aborigines/aboscream2.wav" => s.wav["e"];
"../../_SAMPLES/Aborigines/aboscream3.wav" => s.wav["f"];
"../../_SAMPLES/Aborigines/aboscream4.wav" => s.wav["g"];
"../../_SAMPLES/Aborigines/aboscream5.wav" => s.wav["h"];
"../../_SAMPLES/Aborigines/aboscream6.wav" => s.wav["i"];
...
4 * data.tick => s.the_end.fixed_end_dur;  // 16 * data.tick => s.extra_end;   //s.print();
