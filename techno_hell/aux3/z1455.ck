...
"
*2
m__m __m_ m__m *2 mm_m m_mm :2
mmm_ _m__ m__m *2 _m_m _m_m :2
mm__ mm_m _m_m *2 m_m_ mmmm :2
...
//// SUBWAV ////
//SEQ s2; SET_WAV.TRANCE(s2); s.add_subwav("m", s2.wav["K"]); s.gain_subwav("m", 0, .1);
s.go();     s $ ST @=> ST @ last; 
