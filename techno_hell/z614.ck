...
STFILTERMOD fmod;
fmod.connect( last , "ResonZ" /* "HPF" "BPF" BRF" "ResonZ" */, 5 /* Q */, 2600 /* f_base */ , 3400  /* f_var */, 1::second / (2 * data.tick + 10::ms) /* f_mod */);     fmod  $ ST @=>  last; 

//STECHO ech;
//ech.connect(last $ ST , data.tick * 1 / 8 , .4);  ech $ ST @=>  last; 
