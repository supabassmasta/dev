class synt0 extends SYNT{
    ...
    100 * 26 => adsrop[i].gain;
    i++;

    //---------------------
    opin[i] => osc[i] => adsrop[i] => opout[i];
    1./102. +0.0 => opin[i].gain;
    ...
    16::second/(4*data.tick) => sin.freq;
...
STAUTOPAN autopan;
autopan.connect(last $ ST, .9 /* span 0..1 */, 3*data.tick /* period */, 0.15 /* phase 0..1 */ );       autopan $ ST @=>  last; 
