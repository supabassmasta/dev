...
STEPC stepc; stepc.init(HW.lpd8.potar[1][6], .2 /* min */, 10 /* max */, 10::ms /* transition_dur */);
stepc.out =>  SinOsc s => Gain gsin=> Gain out;
3 => gsin.op;
STEPC stepc2; stepc2.init(HW.lpd8.potar[1][5], 0 /* min */, 30 /* max */, 10::ms /* transition_dur */);
stepc2.out => gsin;  
