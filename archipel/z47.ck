...
STEPC stepc; stepc.init(HW.lpd8.potar[1][8], .2 /* min */, 5 /* max */, 50::ms /* transition_dur */);
stepc.out =>  SqrOsc s => Gain gsin=> Gain out;
3 => gsin.op;
STEPC stepc2; stepc2.init(HW.lpd8.potar[1][7], 0 /* min */, .3 /* max */, 50::ms /* transition_dur */);
stepc2.out => gsin;  
