...
STEPC stepc; stepc.init(HW.lpd8.potar[1][6], 0 /* min */, 8000 /* max */, 50::ms /* transition_dur */);
stepc.out =>  s0.inlet;
...
STEPC stepc2; stepc2.init(HW.lpd8.potar[1][7], 0 /* min */, 30 /* max */, 50::ms /* transition_dur */);
stepc2.out => mult; 

STEPC stepc3; stepc3.init(HW.lpd8.potar[1][8], 0 /* min */, 100 /* max */, 50::ms /* transition_dur */);
stepc3.out => z; 
...
<<<"Potar 1.7 FM olsiclator Gain ">>>;
<<<"Potar 1.8 FM olsiclator FReq ">>>;
