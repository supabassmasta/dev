...
stsynclpf.freq(100 /* Base */, 9 * 100 /* Variable */, 3. /* Q */);
...
STFILTERMOD fmod;
fmod.connect( last , "ResonZ" /* "HPF" "BPF" BRF" "ResonZ" */, 6 /* Q */, 100 /* f_base */ , 900  /* f_var */, 1::second / (9 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 

STGAIN stgain;
stgain.connect(last $ ST , 1. /* static gain */  );       stgain $ ST @=>  last; 
stgain.connect(stsynclpf $ ST , 1. /* static gain */  );       stgain $ ST @=>  last; 
