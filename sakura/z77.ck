...
l.start(1::ms /* sync */ , 16 * (60::second / 126)  /* offset */ ,  1 *32 * data.tick /* loop (0::ms == disable) */ , 0 * data.tick /* END sync */); l $ ST @=> ST @ last;  
//l.start(1::ms /* sync */ , (5 * 32 + 16 ) * (60::second / 126)  /* offset */ ,  1 *32 * data.tick /* loop (0::ms == disable) */ , 0 * data.tick /* END sync */); l $ ST @=> ST @ last;  
