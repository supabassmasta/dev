...
STECHOV echv;
echv.connect(last $ ST , data.tick * 2 /* delay max */, 1::samp /* update rate */);  echv $ ST @=>  last; 
 spork ~ echv.control (data.tick * 3 /4 /* delay sart */ , data.tick * 1 /8/* delay stop */, data.tick * 4 /* delay transition dur */, .8 /* gainstart */, 0.6 /* gainstop */, data.tick * 4 /* gain_trans_dur */ );  // Use control for classical ramping delay and gain control, or connect below 
