...
STROTATE strot;
strot.connect(last $ ST , 0.3 /* freq */  , 0.5 /* depth */, 0.7 /* width */, 1::samp /* update rate */ ); strot$ ST @=>  last; 
// => strot.sin0;  => strot.sin1; // connect to make freq change 

STGVERB stgverb;
stgverb.connect(last $ ST, .04 /* mix */, 4 * 10. /* room size */, 1::second /* rev time */, 0.2 /* early */ , 0.6 /* tail */ ); stgverb $ ST @=>  last; 
