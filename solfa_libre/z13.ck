...
//stlpfx0.connect(last $ ST ,  stlpfx0_fact, 50* 100.0 /* freq */ , 1.0 /* Q */ , 1 /* order */, 1 /* channels */ );       stlpfx0 $ ST @=>  last;  

STAUTOPAN autopan;
autopan.connect(last $ ST, .6 /* span 0..1 */, data.tick * 7 / 2 /* period */, 0.95 /* phase 0..1 */ );       autopan $ ST @=>  last; 
