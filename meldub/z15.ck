...
"*2 {2  ___<s __<s_ __<s<s __<s_" => s.seq;
0.5 * data.master_gain => s.gain; // s.gain("s", .2); // for single wav 
...
STADSR stadsr;
stadsr.set(2::ms /* Attack */, 8::ms /* Decay */, 0.6 /* Sustain */, 7 *10::ms /* Sustain dur of Relative release pos (float) */,  10::ms /* release */);
