...
STAUTOFILTERX stautoresx0; RES_XFACTORY stautoresx0_fact;
ph => stautoresx0.sin0.phase;
stautoresx0.connect(last $ ST ,  stautoresx0_fact, 2.0 /* Q */,600 /* freq base */, 23 * 100 /* freq var */, data.tick * 5 / 2/* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautoresx0 $ ST @=>  last;  
...
fun void  LOOP_MOD_SLIDES (){ 
  ...
  spork ~ MEGAMOD (160  /*137*/ , 23 /* nmod */, "*8 }c  " + RAND.seq("1_1_, 8_,1_, ", 8),"*8 81/fc8/3 " /* modf */, "*4 " + RAND.char ("fim", 5) /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
  4 * data.tick => w.wait;
  spork ~   SUPSAW (" c/A", .7, "*2 1/88/1" ,1.9); 
  spork ~ MEGAMOD (162  /*137*/ , 23 /* nmod */, "*8 }c  " + RAND.seq("1_1_, 8_,1_, ", 8),"1////f " /* modf */, "*4 " + RAND.char ("fim", 5) /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;

  4 * data.tick => w.wait;
  spork ~   SUPSAW ("*2 f/P", .6, "*2 1/8" ,1.9); 
  spork ~ MEGAMOD (162  /*137*/ , 23 /* nmod */, "*8 }c  " + RAND.seq("1_1_, 8_,1_, ", 8),"1////f " /* modf */, "*4 " + RAND.char ("fim", 5) /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
  4 * data.tick => w.wait;
  spork ~ MEGAMOD (140  /*137*/ , 23 /* nmod */, "*8 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*8 8cf " + RAND.char(" 8cf", 8) /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
  4 * data.tick => w.wait;
  ...
  4 * data.tick => w.wait;
  spork ~ MEGAMOD (140  /*137*/ , 23 /* nmod */, "*8 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*8 8cf " + RAND.char(" 8cf", 8) /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
  spork ~   SUPSAW ("*2 M/f", .6, "*2 8/1" ,1.9); 
  4 * data.tick => w.wait;
  spork ~ MEGAMOD (138  /*137*/ , 23 /* nmod */, "*2 8 " + RAND.char("18f5B3a///////", 8) ,"*8 8cf " + RAND.char(" 8cf", 8) /* modf */, "*2 fim" /*modg*/, "8" /* g curve */, 4 * data.tick, .6)  ;
  4 * data.tick => w.wait;
//  spork ~ MEGAMOD (162  /*137*/ , 23 /* nmod */, "*8 }c  " + RAND.seq("1_1_, 8_,1_, ", 8),"1////f " /* modf */, "*4 " + RAND.char ("fim", 5) /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
...
fun void  LOOPLAB0  (){ 
  while(1) {
//  spork ~ MEGAMOD (133  /*137*/ , 23 /* nmod */, "*8  1_1_ 1___ 1___ 1_1_ __5_ __1_ 1___ 1___ 1_1_ 1___  1_1_ __1_ __1_ 8___" ,":8}c 3//55//3 " /* modf */, "n" /*modg*/, ":8 8" /* g curve */, 16 * data.tick, 0.9)  ;
//  spork ~ MEGAMOD (140  /*137*/ , 23 /* nmod */, "*8 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*8 8cf " + RAND.char(" 8cf", 8) /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
//  spork ~ MEGAMOD (137  /*137*/ , 23 /* nmod */, "*6 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*2 8 " + RAND.char("/// 8cf", 8) + "8" /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
     spork ~ SUPSAWSLIDE  ("}c *2____ ___5|c ____  ", .4 /* filter mod phase */, 2.0 /* gain */);
  spork ~   SIN ("}c}c _8  *8 5___ ____ :8 _  __ *8*2 {c 8___ 8___ ____ 8___ f___ __ "   , .35 ); 
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;
  spork ~ MEGAMOD (140  /*137*/ , 23 /* nmod */, "*8 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*8 8cf " + RAND.char(" 8cf", 8) /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
  ...
  spork ~ MEGAMOD (133  /*137*/ , 23 /* nmod */, "*8 " + RAND.seq(" 1_,1_,1_,5_,8_,F_,__,*2f___:2", 8),":8}c 3//55//3 " /* modf */, "n" /*modg*/, ":8 8" /* g curve */, 4 * data.tick, 0.9)  ;

    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k__k  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!1!1 __!1!1 __!1_  "); 
    8 * data.tick => w.wait;

  spork ~ SUPSAWSLIDE  ("}c :2 8///H  ", Std.rand2f(.2,.9)/* filter mod phase */, 1.8 /* gain */);
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;
  ...
  spork ~ SUPSAWSLIDE  ("}c :2 G////8  ", Std.rand2f(.2,.9)/* filter mod phase */, 1.8 /* gain */);
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;
...
//  spork ~ MEGAMOD (137  /*137*/ , 23 /* nmod */, "*6 }c " + RAND.seq(" 1_,1_,1_,8_,8_", 8) ,"*2 8 " + RAND.char("/// 8cf", 8) + "8" /* modf */, "f" /*modg*/, "8" /* g curve */, 4 * data.tick, .7)  ;
//     spork ~ SUPSAWSLIDE  ("}c *2_8__ ___8|f ____  ", .4 /* filter mod phase */, 2.3 /* gain */);
  spork ~   SIN ("}c  *4 __ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___  4 8___  "   , .6 ); 
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_hs "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;

  spork ~   SIN ("}c  *4 __ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___  *48_8_ __8_ 4___ f  "   , .6 ); 
...
//  32 * data.tick => w.wait;
    ...
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k__k  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __  "); 
    8 * data.tick => w.wait;
    ...
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k_k_ k_k_  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_hs "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;

    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k_k_ kk_k  "); 
    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __  "); 
    8 * data.tick => w.wait;
...
//     spork ~ SUPSAWSLIDE  ("}c *2_8__ ___8|f ____  ", .4 /* filter mod phase */, 2.3 /* gain */);
//  spork ~   SIN ("}c  *4 __ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___ *4 8___ :4 ___  4 8___  "   , .6 ); 
  spork ~   PADS (" :8 :4 1|3_" , 24, .2 ); 
  32 * data.tick => w.wait;
    spork ~   PADS (" :8 :4 1|8_" , 12, .2 ); 
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 1|3_" , 22, .2 ); 
  32 * data.tick => w.wait;
   spork ~   PADS (" :8 :2 8|5_" , 13, .2 ); 
  32 * data.tick => w.wait;
 }
}
fun void  LOOPLAB3  (){ 
  while(1) {
    spork ~  TABLA ("*4xxY_ z__X _xzx x__z Xx__ zy__  xzy _ycz   "); 
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
//    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_hs "); 
    spork ~  BASS0 ("*4  __!11 __!11 __!11 __!11   __!11 __!11 __!11 __!1!1  "); 
    8 * data.tick => w.wait;
...
//    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_hs "); 
    ...
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k_k_  "); 
//    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!1!1 __!1!1 __!1!1 __!1!1   __!1!1 __!1!1 __!1!1 __!5!1  "); 
    8 * data.tick => w.wait;
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k___  "); 
//    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_hs "); 
    spork ~  BASS0 ("*4  __!1!1 __!1!1 __!1!1 __!1!1   __!1!1 __!1!1 __!1!1 __!1!1  "); 
    ...
    spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___ k__k  "); 
//    spork ~  TRANCEHH ("*4 -2 __h_ -4 s_h_ __h_ s_h_ __h_ s_h_ __h_ s_h_ "); 
    spork ~  BASS0 ("*4  __!1!1 __!1!1 __!1!1 __!1!1   __!1!1 __!1!1 __!1!1 __!8!1  "); 
    8 * data.tick => w.wait;
