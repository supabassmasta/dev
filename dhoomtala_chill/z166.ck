ST st; st @=> ST @ last;
STEPC stepc; stepc.init(HW.lpd8.potar[1][8],.1 /* min */, 15 /* max */, 50::ms /* transition_dur */);
...
flang.add_line(0 /* 0 : left, 1: right 2: both */, .8 /* delay line gain */,  31::ms /* dur base */, 10::ms /* dur range */, 2 /* freq */); 
flang.add_line(1 /* 0 : left, 1: right 2: both */, .8 /* delay line gain */,  42::ms /* dur base */, 13::ms /* dur range */, 2.2 /* freq */); 
...
// STCUTTER stcutter;
// "*8 
// 431543131431531314313131431543131
// " => stcutter.t.seq;
// stcutter.connect(last, 1::ms /* attack */, 1::ms /* release */ );   stcutter $ ST @=> last; 
// 
STECHO ech;
ech.connect(last $ ST , data.tick * 6 / 4 , .7);  ech $ ST @=>  last; 
