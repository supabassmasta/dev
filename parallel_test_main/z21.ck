...
"*4 
k___ k___ k___ k___   k___ k___ k___ kk_k
k___ k___ k___ k___   k___ k___ k___ _k_k
k___ k___ k___ k___   k___ k___ k___ _kk_
k___ k___ k___ k___   k___ k___ k___ kkk_
...
STLPF lpf;
lpf.connect(last $ ST , 7 * 100 /* freq */  , 1.0 /* Q */  );       lpf $ ST @=>  last; 
while(1) {
       100::ms => now;
}
