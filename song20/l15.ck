...
stsynclpf2.freq(100 /* Base */, 11 * 100 /* Variable */, 1.0 /* Q */);
stsynclpf2.adsr_set(.4 /* Relative Attack */, .0/* Relative Decay */, 1. /* Sustain */, .2 /* Relative Sustain dur */, 0.4 /* Relative release */);
stsynclpf2.connect(t $ ST, t.note_info_tx_o); stsynclpf2 $ ST @=>  last; 

//STSYNCLPF stsynclpf;
//stsynclpf.freq(100 /* Base */, 13 * 100 /* Variable */, 2.9 /* Q */);
