...
class KICK_CUSTOM extends Chubgraph{

  Step stp0 =>  Envelope e0 =>  SinOsc sin0 =>  Envelope e1 => outlet; 
  1.0 => stp0.next;
  0.0 => e1.value;
  1.0 => sin0.gain;
  ...
  fun void  trig_freq  (){ 
    76 * 100 => e0.value;
    233.0 => e0.target;
    10::ms => e0.duration  => now;
    100.0 => e0.target;
    20::ms => e0.duration  => now;

    35.0 => e0.target;
    17 * 10::ms => e0.duration  => now;
...
ST st;
KC => st.mono_in; st @=>  last; 
.25 => st.gain;

STDUCKMASTER duckm;
duckm.connect(last $ ST, 7. /* In Gain */, .04 /* Tresh */, .2 /* Slope */, 3::ms /* Attack */, 20::ms /* Release */ );      duckm $ ST @=>  last; 
...
STSYNCFILTERX stsynclpfx0; LPF_XFACTORY stsynclpfx0_fact;
stsynclpfx0.freq(14 * 10 /* Base */, 89 * 10 /* Variable */, 1. /* Q */);
stsynclpfx0.adsr_set(.01 /* Relative Attack */, .09/* Relative Decay */, 0.7 /* Sustain */, .5 /* Relative Sustain dur */, 0.2 /* Relative release */);
stsynclpfx0.nio.padsr.setCurves(1.0, 0.01, 1.0); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave
stsynclpfx0.connect(last $ ST ,  stsynclpfx0_fact, t.note_info_tx_o , 3 /* order */, 1 /* channels */ , 1::samp /* period */ );       stsynclpfx0 $ ST @=>  last; 
// CONNECT THIS to play on freq target //     => stsynclpfx0.nio.padsr; 

STFILTERX stlpfx0; LPF_XFACTORY stlpfx0_fact;
stlpfx0.connect(last $ ST ,  stlpfx0_fact, 305.0 /* freq */ , 1.0 /* Q */ , 2 /* order */, 1 /* channels */ );       stlpfx0 $ ST @=>  last;  

STPADSR stpadsr;
stpadsr.set(3::ms /* Attack */, 34::ms /* Decay */, 0.7 /* Sustain */, 17::ms /* Sustain dur of Relative release pos (float)*/,  40::ms /* release */);
...
//STDELAY2 stdely2; // Stereo simple delay + passthrough
//stdely2.connect(last $ ST , 12::ms /* delay right */, 15::ms /* delay left */, 0.3 /* delay gain */ );
//       stdely2 $ ST @=>  last;   
...
STSYNCFILTERX stsynclpfx0; LPF_XFACTORY stsynclpfx0_fact;
stsynclpfx0.freq(20 * 10 /* Base */, 54 * 10 /* Variable */, 1. /* Q */);
stsynclpfx0.adsr_set(.01 /* Relative Attack */, .16/* Relative Decay */, 0.7 /* Sustain */, .5 /* Relative Sustain dur */, 0.2 /* Relative release */);
stsynclpfx0.nio.padsr.setCurves(1.0, 0.01, 1.0); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave
stsynclpfx0.connect(last $ ST ,  stsynclpfx0_fact, t.note_info_tx_o , 3 /* order */, 1 /* channels */ , 1::samp /* period */ );       stsynclpfx0 $ ST @=>  last; 
// CONNECT THIS to play on freq target //     => stsynclpfx0.nio.padsr; 
...
stcrossover0.connect(last $ ST , 64 /* freq */ , 1.0 /* Q */ , 1 /* order */, 1 /* channels */, 1.0 /* LPF Gain */ );       stcrossover0 $ ST @=>  last;   
...
t.no_sync();//  t.full_sync(); // 1 * data.tick => t.the_end.fixed_end_dur;  // 16 * data.tick => t.extra_end;   //t.print(); //t.force_off_action();
// t.mono() => dac;//  t.left() => dac.left; // t.right() => dac.right; // t.raw => dac;
t.set_adsrs(1::samp, data.tick *1/16, .6, data.tick *1/16);
//t.set_adsrs_curves(2.0, 2.0, 0.5); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave
1 => t.set_disconnect_mode;
t.go();   t $ ST @=> ST @ last; 
...
//ADSRMOD adsrmod; // Direct ADSR freq input modulation
//adsrmod.adsr_set(0.01 /* relative attack dur */, 0.1 /* relative decay dur */ , 0.8 /* sustain */, - 0./* relative release pos */, .0 /* relative release dur */);
//adsrmod.padsr.setCurves(1., 0.7, 2.); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave 
//adsrmod.connect(s0 /* synt */, t.note_info_tx_o /* note info TX */); 
...
//STCROSSOVER stcrossover0;
//stcrossover0.connect(last $ ST , 58 /* freq */ , 1.0 /* Q */ , 1 /* order */, 1 /* channels */, 1.0 /* LPF Gain */ );       stcrossover0 $ ST @=>  last;   
...
//  spork ~  BASS13 ("*4 _!1!1!1 ___!1 _!1!1!1 _8///1 _!1!1!1 _!1!3!1 ___!8 _!8!5!1 _    "); 
  spork ~  BASS16 ("*4   __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1_   "); 
