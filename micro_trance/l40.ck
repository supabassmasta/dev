...
class SERUM00X extends SYNT{
  ...
  fun void on()  { }  fun void off() { }  fun void new_note(int idx)  { 0.43 =>p.phase; } 1 => own_adsr;
} 
...
stsynclpfx0.freq(11 * 10 /* Base */, 57 * 10 /* Variable */, 1. /* Q */);
stsynclpfx0.adsr_set(.0 /* Relative Attack */, 53*  .01/* Relative Decay */, 0.18 /* Sustain */, .19 /* Relative Sustain dur */, 0.2 /* Relative release */);
