...
class SERUM00X extends SYNT{
  ...
  fun void on()  { }  fun void off() { }  fun void new_note(int idx)  { 0.33 =>p.phase; } 1 => own_adsr;
} 
...
stsynclpfx0.adsr_set(.0 /* Relative Attack */, 57*  .01/* Relative Decay */, 0.14 /* Sustain */, .19 /* Relative Sustain dur */, 0.2 /* Relative release */);
