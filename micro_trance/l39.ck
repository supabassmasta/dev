...
fun void  LOOP_CRAZY_SYNT8_2  (){ 
   ...
   if(maybe) 
     ...
     spork ~ MEGAMOD (Std.rand2(2650, 2652)  /*137*/ , 23 /* nmod */, "____*8 }c 8 " + RAND.seq("f_,c_,5_,4_,1_,8_,8_,b_,c_,f_,3_", 16)  + "_", "*8" + RAND.char("fB18", 16 ) /* modf */, "*2 a" /*modg*/, "8" /* g curve */, 8 * data.tick, 1.1)  ;
8 *data.tick => now;
   } 
