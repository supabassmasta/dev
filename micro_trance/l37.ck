...
stsynclpfx0.freq(11 * 10 /* Base */, 96 * 10 /* Variable */, 1. /* Q */);
stsynclpfx0.adsr_set(.0002 /* Relative Attack */, 80*  .01/* Relative Decay */, 0.12 /* Sustain */, .3 /* Relative Sustain dur */, 0.4 /* Relative release */);
