...
"l42_main.wav" => string name_main;
"l42_aux.wav" => string name_aux;
...
//if ( 0  ){
    ...
    1 * data.tick  =>  w.wait; // ??????????????? DONTKNOW WHY
//}
...
for (0 => int i; i < 3 ; i++) {
  ...
  spork ~  SLIDENOISE(8000 /* fstart */, 200 /* fstop */, 8* data.tick /* dur */, .1 /* width */, .09 /* gain */); 
