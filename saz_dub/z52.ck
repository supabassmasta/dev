...
"{c*2 4!4 !4_4_  4!4 !4_4_ 555_ 4___555_ 4___ 
...
stsynckgx0.freq(100 /* Base */, 10 * 100 /* Variable */, 2. /* Q */);
stsynckgx0.adsr_set(.1 /* Relative Attack */, .3/* Relative Decay */, 0.9 /* Sustain */, .5 /* Relative Sustain dur */, 0.1 /* Relative release */);
stsynckgx0.nio.padsr.setCurves(1.0, 1.2, 1.0); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave
stsynckgx0.connect(last $ ST ,  stsynckgx0_fact, t.note_info_tx_o , 2 /* order */, 1 /* channels */ , 1::ms /* period */ );       stsynckgx0 $ ST @=>  last; 
