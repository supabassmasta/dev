...
STFILTERMOD fmod2;
fmod2.connect( last , "ResonZ" /* "HPF" "BPF" BRF" "ResonZ" */, 5 /* Q */, 170 /* f_base */ , 34 * 100  /* f_var */, 1::second / (3 * data.tick) /* f_mod */);     fmod2  $ ST @=>  last; 
...
STHPF hpf;
hpf.connect(last $ ST , 11 *10 /* freq */  , 1.0 /* Q */  );       hpf $ ST @=>  last; 
