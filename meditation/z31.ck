...
while(1) {
  spork ~  RANDSERUM2("*8 " /* Seq begining */ , 10 /* Nb rand elements */ ); 
  4 * data.tick =>  w.wait; 

  spork ~  RAND("*6 }c" /* Seq begining */ , 6 /* Nb rand elements */ ); 
  4 * data.tick =>  w.wait; 
 
  spork ~  RANDSERUM2("*4 }c" /* Seq begining */ , 6 /* Nb rand elements */ ); 
  4 * data.tick =>  w.wait; 
 
  spork ~  RAND("*4 }c" /* Seq begining */ , 6 /* Nb rand elements */ ); 
  4 * data.tick =>  w.wait; 
}
