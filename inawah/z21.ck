...
class STSYNCWPKorg35 extends ST{
  WPKorg35 filterl => outl;
  WPKorg35 filterr => outr;
...
true => filterl.nonlinear => filterr.nonlinear;
  ...
  fun void freq(float base, float variable, float res, int nonlinear){
    base => nio.base.next;
...
stsynckorg.freq(3*100 /* Base */, 2 * 100 /* Variable */, 1.1 /*   /!\ < 1.7 !!!!   resonance */ , true /* nonlinear */ );
stsynckorg.adsr_set(.1 /* Relative Attack */, .7/* Relative Decay */, 0.00001 /* Sustain */, .0 /* Relative Sustain dur */, 0.0 /* Relative release */);
...
//
STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 4 /* Q */, 160 /* f_base */ , 1 * 140  /* f_var */, 1::second / (7 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
