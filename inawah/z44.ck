...
STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 2 /* Q */, 60 * 10 /* f_base */ , 30 * 100  /* f_var */, 1::second / (16 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 
...
STECHO ech;
ech.connect(last $ ST , data.tick * 4 / 6 , .7);  ech $ ST @=>  last; 
