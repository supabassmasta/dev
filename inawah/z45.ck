...
STSYNCLPF stsynclpf;
stsynclpf.freq(6 * 100 /* Base */, 66 * 100 /* Variable */, 4. /* Q */);
stsynclpf.adsr_set(.4 /* Relative Attack */, .0/* Relative Decay */, 1. /* Sustain */, 1.4 /* Relative Sustain dur */, 1.4 /* Relative release */);
