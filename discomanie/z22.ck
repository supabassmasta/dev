...
" :8 !1|3|5_8|5|3_0|1|3_3|5|7_" => t.seq;
...
flang.add_line(0 /* 0 : left, 1: right 2: both */, .6 /* delay line gain */,  6::ms /* dur base */, 2::ms /* dur range */, 2/4 /* freq */); 
flang.add_line(1 /* 0 : left, 1: right 2: both */, .6 /* delay line gain */,  6::ms /* dur base */, 3::ms /* dur range */, 5/4 /* freq */); 
