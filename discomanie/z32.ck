...
"}c}c _1|3|5__ ____ ____ ____" => t.seq;
...
stautolpfx0.connect(last $ ST ,  stautolpfx0_fact, 2.0 /* Q */, 16 * 100 /* freq base */, 21 * 100 /* freq var */, data.tick * 9 / 2 /* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautolpfx0 $ ST @=>  last;  
