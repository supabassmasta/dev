...
//s0.config(.5 /* G */, 1::second /* ATTACK */, 1::second /* RELEASE */,"../_SAMPLES/SYNTWAVS/MULTI2SIN0"/* FILE */, 100::ms /* UPDATE */); 
s1.config(.5 /* G */, 1::second /* ATTACK */, 1::second /* RELEASE */,"../_SAMPLES/SYNTWAVS/MULTI2SIN0"/* FILE */, 100::ms /* UPDATE */); 
t.dor();// t.aeo(); // t.phr();// t.loc(); t.double_harmonic(); t.gypsy_minor();
// _ = pause , | = add note to current , * : = mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = shift base note , ! = force new note , # = sharp , ^ = bemol  
//":4 {1 BBB|5B BBB|1B" => t.seq;
":4 1" => t.seq;
.02 * data.master_gain => t.gain;
...
STROTATE strot;
strot.connect(last $ ST , 0.6 /* freq */  , 0.3 /* depth */, 0.4 /* width */, 1::samp /* update rate */ ); strot$ ST @=>  last; 
