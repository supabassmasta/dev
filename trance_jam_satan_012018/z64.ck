class synt0 extends SYNT{
    ...
    24::second/(2*data.tick) => sin.freq;
...
STFILTERMOD fmod;
fmod.connect( last , "LPF" /* "HPF" "BPF" BRF" "ResonZ" */, 5 /* Q */, 1600 /* f_base */ , 2400  /* f_var */, 17::second / (2 * data.tick) /* f_mod */);     fmod  $ ST @=>  last; 

//STDIGIT dig;
//dig.connect(last $ ST , 5::samp /* sub sample period */ , .0001 /* quantization */);      dig $ ST @=>  last; 
