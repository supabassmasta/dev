...
STLIMITER stlimiter;
13. => float in_gainl;
stlimiter.connect(last $ ST , in_gainl /* in gain */, 1./in_gainl /* out gain */, 0.0 /* slopeAbove */,  1.0 /* slopeBelow */ , 0.5 /* thresh */, 5::ms /* attackTime */ , 30::ms /* releaseTime */);   stlimiter $ ST @=>  last;   
...
STBRF brf;
brf.connect(last $ ST , 11000 /* freq */  , 1.0 /* Q */  );       brf $ ST @=>  last; 
...
// ECHO SEND
STGAINC gainc2;
gainc2.connect(brf $ ST , HW.lpd8.potar[1][7] /* gain */  , 1. /* static gain */  );       gainc2 $ ST @=>  last; 
...
// DIRECT BEAT  GAIN
STGAINC gainc;
gainc.connect(stmix $ ST , HW.lpd8.potar[1][8] /* gain */  , 2. /* static gain */  );       gainc $ ST @=>  last; 
