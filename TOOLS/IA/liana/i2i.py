...
#last_image = "molecule146.jpeg"
last_image = "liana4080.jpeg"

prompt = " aliens, planets, electronic circuit, space ships"

i=4081
while True :
  init_image = Image.open(last_image).convert("RGB")
  images = pipe(prompt=prompt, image=init_image, strength=0.5, guidance_scale=5.5, num_inference_steps=50).images
