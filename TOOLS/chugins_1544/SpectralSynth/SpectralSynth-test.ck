...
//    (the bulid process should yield a SpectralSynth.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:SpectralSynth.chug SpectralSynth-test.ck`
//
...
//    `chuck --chugin:SpectralSynth.chug SpectralSynth-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a SpectralSynth
SpectralSynth obj;
