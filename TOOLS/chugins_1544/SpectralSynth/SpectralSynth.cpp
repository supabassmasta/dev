...
//         (e.g., `QUERY->begin_class(QUERY, "SpectralSynth", "Object");`)
//      2. remove or commment out the line containing QUERY->add_ugen_func()
//      3. that's it; the rest is no different for UGens/non-UGens
//-----------------------------------------------------------------------------
// NOTE once you have built this into a chugin (SpectralSynth.chug), here are a few
//      helpful tools for testing / probing / verifying your new chugin!
//
// chuginate also generated a SpectralSynth-test.ck boilerplate ChucK program
//      to help test your chugin (see SpectralSynth-test.ck for more instructions)
//
...
CK_DLL_MFUN( spectralsynth_setParam );
CK_DLL_MFUN( spectralsynth_getParam );
...
CK_DLL_QUERY( SpectralSynth )
{
    ...
    QUERY->add_mfun( QUERY, spectralsynth_setParam, "float", "param" );
    // example of adding argument to the above method
    QUERY->add_arg( QUERY, "float", "arg" );

    // example of adding getter method
    QUERY->add_mfun( QUERY, spectralsynth_getParam, "float", "param" );
...
CK_DLL_CTOR( spectralsynth_ctor )
{
    ...
    SpectralSynth * ss_obj = new SpectralSynth( API->vm->srate(VM) );
    
    // store the pointer in the ChucK object member
    OBJ_MEMBER_INT( SELF, spectralsynth_data_offset ) = (t_CKINT)ss_obj;
}
...
CK_DLL_DTOR( spectralsynth_dtor )
{
    ...
    SpectralSynth * ss_obj = (SpectralSynth *)OBJ_MEMBER_INT( SELF, spectralsynth_data_offset );
    // clean up (this macro tests for NULL, deletes, and zeros out the variable)
    CK_SAFE_DELETE( ss_obj );
...
CK_DLL_MFUN( spectralsynth_setParam )
{
    ...
    RETURN->v_float = ss_obj->setParam( arg1 );
}
...
CK_DLL_MFUN(spectralsynth_getParam)
{
    ...
    RETURN->v_float = ss_obj->getParam();
}
