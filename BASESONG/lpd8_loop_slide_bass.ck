...
// ****  SYNT *****
	...
	inlet => Gain in => SinOsc main => Gain final => outlet;
	.6 => final.gain;
  ...
  2. => two.gain;
	...
	inlet => Gain two_bis => ADSR slide_attack => in;
	2. => two_bis.gain;
	slide_attack.set(0::ms, 20::ms, 0.000000001, 1::ms);
...
// SYNT
   ...
   f.adsr.set(2::ms, 15::ms, 0.85,140::ms);
