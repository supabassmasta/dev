...
////////////////////////////////////////////////////////////////////////////////////////
fun void MEGAMODM (int n, int nmod, string seq, string modf, string modg, string g_curve, dur d, int mix, float g){ 
...
STCONVREV stconvrev;
stconvrev.connect(last $ ST , 1/* ir index */, 1 /* chans */, 10::ms /* pre delay*/, 4 * .01 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
...
STCONVREV stconvrev2;
stconvrev2.connect(last $ ST , 1/* ir index */, 1 /* chans */, 10::ms /* pre delay*/, 4 * .01 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev2 $ ST @=>  last;  
...
fun void  LOOP_CRAZY_SYNT8_3  (){ 
   if(maybe) 
     spork ~ MEGAMOD2 (Std.rand2(2,4) /*137*/ , 23 /* nmod */, " } " + RAND.char("158fFB", 1) + RAND.seq("_i/B,B///g, f/R__, 8,f",2) + "_" , RAND.char(" ZXYW", 1)  /* modf */, RAND.char("}5 18af", 1) /*modg*/, "8" /* g curve */, 4 * data.tick, 0.5)  ;
    else
      spork ~ MEGAMODM (Std.rand2(2650, 2652)  /*137*/ , 23 /* nmod */, "*8 }c 8 " + RAND.seq("f_,c_,5_,4_,1_,8_,8_,b_,c_,f_,3_", 16)  + "_", "*8" + RAND.char("{c ZXYW", 16 ) /* modf */, "*2 a" /*modg*/, "8" /* g curve */, 4 * data.tick, 1, 0.7)  ;
    
    if(maybe) 
      spork ~ MEGAMODM (Std.rand2(2650, 2652)  /*137*/ , 23 /* nmod */, "____*4 }c 8 " + RAND.char("fc54188bcf3____///", 12)  + "_"," 1//ff/BB/1 "  /* modf */, "*2 a" /*modg*/, "8" /* g curve */, 8 * data.tick, 1, 0.7)  ;
    else  
      spork ~ MEGAMODM (Std.rand2(2650, 2652)  /*137*/ , 23 /* nmod */, "____*4 }c 8 " + RAND.seq("f_,c_,5_,7_,1_,8_,8_,b_,c_,f_,3_,*2", 16)  + "_", "*8" + RAND.char("58f", 16 ) /* modf */, "*2 a" /*modg*/, "8" /* g curve */, 8 * data.tick, 1, 0.7)  ;
8 *data.tick => now;
   } 
...
fun void SEQPADS   (){ 
  ...
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 5|7_" , 14, .3 ); 
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 1|0_" , 15, .3 ); 
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 1|3_" , 16, .3 ); 
  16 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 1|5_" , 13, .3 ); 
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 5|7_" , 14, .3 ); 
  32 * data.tick => w.wait;
  spork ~   PADS (" :8 :4 1|0_" , 15, .3 ); 
...
spork ~  LOOP_CRAZY_SYNT8_3  (); 


//     spork ~  KICK3 ("*4 k___ k___ k___ k___ k___ k___ k___k___   ");
//     spork ~  BASS0 ("*4      -6    _1!2!1_!1!3!1_!1!1!1_!1!3!1_!1!2!1_!1!3!1_!1!1!1_!2!3!1_ "); 
