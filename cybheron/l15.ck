...
fun void  BEAT3_8x8  (){ 
    ...
    spork ~KICK("*4     k___ k___ k___ k___ k___ k___ k___ __k_",0,1.);
    spork ~ BASS0(" *4 !1111 __11 ____ __11!1111 __33 __11 ____     ",0,1.);
    8 * data.tick =>  w.wait; 
    ...
    spork ~KICK("*4     k___ k___ k___ k___ k___ k___ k___ ____",0,1.);
    spork ~ BASS0(" *4 !1111 __11 ____ __11!1111 __33 __5// ////1     ",0,1.);
    8 * data.tick =>  w.wait; 
    ...
    spork ~KICK("*4     k___ k___ k___ k___ k___ k___ k___ k_kk",0,1.);
    spork ~ BASS0(" *4 !1111 __11 ____ __11!1111 __33 __11 ____     ",0,1.);
    8 * data.tick =>  w.wait; 
    ...
    spork ~ ERAMPLPF (10/*mixin*/,8*data.tick,":8 8/5"/*gseq*/,":1m///////MM"/*lpfseq*/,2/*lpforder*/,0,1.0);
...
fun void  FROGSnCOMBS_4x8_8DELAYED  (int n){ 
  1::second / Std.mtof(data.ref_note) => dur comb_dur;
     8 * data.tick => w.wait; 
  for (0 => int i; i < n; i++) {
    spork ~ SYNTFROG ("{c{c{c *2 " + RAND.seq("8/1_,F/1_,__,__,__,__,f/8_,1/8_,F//1,1//F,B//8",8) , 2::ms, 8* data.tick, 3, 3.8);
...
///////////////////////
    ...
    spork ~ BEAT1_8x8();
    4 * 8 * data.tick =>  w.wait;
    spork ~   FROGSnCOMBS_4x8_8DELAYED (1);
    4 * 8 * data.tick =>  w.wait;
