...
stmix.receive(mixer); stmix $ ST @=> ST @ last; 
  ...
  STCONVREV stconvrev;
  stconvrev.connect(last $ ST , 107 /* ir index */, 1 /* chans */, 0::ms /* pre delay*/, .001 * 12 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
...
//    spork ~  TRANCEHH ("*4 +3 {2 __h_   __h_ __h_ __h_ __h_ __h_ __h_ __h_ "); 
    spork ~  TRANCEHH ("*4 +1 {1 __h_   }5+2t_h_ __h_ t_h_ __h_ t_h ___h_ t_h_ "); 
...
// spork ~  BASS0_ATTACK ("*4    __aa __aa __aa __aa __aa __aa __  ", 0.7 /* rate */, .16 /* g */);  
// 8 * data.tick =>  w.wait; 
}
