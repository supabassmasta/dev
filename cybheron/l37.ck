...
fun void PLOCCUT (string seq, string cut, int n, float lpf_f, int tomix, float v) {
  local_delay => now;
...
//.0 => s0.gain;
    .0 => s1.s.phase;
    s0.set_chunk(24); 75.0 => sin0.freq; 7 *10.0 => sin0.gain;.0 => sin0.phase; 0.0 => s0.gain; .0 => s0.p.phase;
...
fun void EFFECT1   (){ 
  ...
  STCONVREV stconvrev;
  stconvrev.connect(last $ ST , 13/* ir index */, 1 /* chans */, 10::ms /* pre delay*/, .03 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
  while(1) {
         100::ms => now;
  }
...
/// PLAY OR REC /////////////////
RECTRACK rectrack; "l37.wav"=>rectrack.name_main; 0=>rectrack.compute_mode; 1=>rectrack.rec_mode;8*data.tick=>rectrack.main_extra_time;8*data.tick=>rectrack.end_loop_extra_time;
...
for (0 => int i; i < 8      ; i++) {
  if ( i == 7  ){
    spork ~  SLIDENOISE(2000 /* fstart */, 200 /* fstop */, 8* data.tick /* dur */, .8 /* width */,2,.14); 
  }
  RAND.seq("!3!2!1!0,!4!3!2!1,!5!3!2!1,!6!4!2!1,!8!5!3!1",8) => string melody;
  spork ~ PLOC(" }c *4__ " + melody , 1322/*n*/,35*100/*cut*/,1,1.8); 
  spork ~ PLOCCUT("}c }c *4__ " + melody, "*4 " + RAND.seq("____ ____ ____ __11, ____ ____ ____ 111_, ____ __11 ____  __11 , ____ ____ ____ 11_1 , ____ ____ ____ 1111 ",2) , 1322/*n*/,35*100/*cut*/,2,1.7); 
...
for (0 => int i; i < 8      ; i++) {
  if ( i == 7  ){
    spork ~  SLIDENOISE(200 /* fstart */, 4000 /* fstop */, 8* data.tick /* dur */, .8 /* width */,2,.14); 
  }
  RAND.seq("!3!2!1!0,!4!3!2!1,!5!3!2!1,!6!4!2!1,!8!5!3!1",8) => string melody;
  spork ~ PLOC(" }c *4__ " + melody , 1322/*n*/,35*100/*cut*/,1,1.8); 
  spork ~ PLOCCUT("}c }c *4__ " + melody, "*4 " + RAND.seq("____ ____ ____ __11, ____ ____ ____ 111_, ____ __11 ____  __11 , ____ ____ ____ 11_1 , ____ ____ ____ 1111 ",2) , 1322/*n*/,35*100/*cut*/,2,1.7); 
...
for (0 => int i; i < 8      ; i++) {
  if ( i == 7  ){
    spork ~  SLIDENOISE(4000 /* fstart */, 200 /* fstop */, 8* data.tick /* dur */, .8 /* width */,2,.14); 
  }
  RAND.seq("!3!2!1!0,!4!3!2!1,!5!3!2!1,!6!4!2!1,!8!5!3!1",8) => string melody;
  spork ~ PLOC(" }c *4__ " + melody , 1322/*n*/,35*100/*cut*/,1,1.8); 
  spork ~ PLOCCUT("}c }c *4__ " + melody, "*4 " + RAND.seq("____ ____ ____ __11, ____ ____ ____ 111_, ____ __11 ____  __11 , ____ ____ ____ 11_1 , ____ ____ ____ 1111 ",2) , 1322/*n*/,35*100/*cut*/,2,1.7); 
