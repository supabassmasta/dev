...
fun void SYNT0 (string seq, string hpf, int mix, float g) {
  TONE t;
  ...
  stfreehpfx0.connect(last $ ST , stfreehpfx0_fact, 3 /* Q */, 2 /* order */, 1 /* channels */ , 1::ms /* period */ ); stfreehpfx0 $ ST @=>  last; 
  AUTO.freq(hpf) => stfreehpfx0.freq; // CONNECT THIS 
...
//spork ~ SYNT0("}c *8 4103124801234 :8 ____ ____", 0, .5);
////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////
...
while(1) { /********************************************************/
  //spork ~ KICK("*4 k___ k___ k___ k___");
  //spork ~ SEQ0("____ *4s__s _ab_ ", 0, .5);
  spork ~ SYNT0("f//F", "F//f", 1, 0.4);
  8 * data.tick =>  w.wait; 
  spork ~ SYNT0("f", "F/f", 1, 0.4);
  8 * data.tick =>  w.wait; 
  spork ~ SYNT0("88", "F//f", 1, 1.0);
  8 * data.tick =>  w.wait; 
  spork ~ SYNT0("88", "f//F", 1, 1.0);
  8 * data.tick =>  w.wait; 
