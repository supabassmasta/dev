...
//   } 
   ...
   fun void  TRANCEHHx8  (int n, int remove_last_beats){ 
     ...
     for (0 => int i; i <  n     ; i++) {
       //      spork ~  TRANCEHH ("*3 +3 {2 __h   _hh__h   _hh__h   _hh__h _hh  "); 
       //      spork ~  TRANCEHH ("*3 +3 {2  _hh _hh _hh _hh _hh _hh _hh _hh  "); 
       spork ~  TRANCEHH ("*3 +1 {2  -6h+6hh -6h+6hh -6h+6hh -6h+6hh -6h+6hh -6h+6hh -6h+6hh -6h+6hh  "); 
       8 * data.tick => w.wait;
     }
     if ( remove_last_beats  ){
       "*3 +3 {2 _hh   }5+3thh" => string seq;
   ...
   fun void  TRANCESNRHHx8  (int n, int remove_last_beats){ 
     ...
     for (0 => int i; i <  n     ; i++) {
spork ~  TRANCEHH ("*3 +1 {2  -6h+6hh }7+8thh -6h+6hh thh -6h+6hh thh -6h+6hh thh  "); 
//      spork ~  TRANCEHH ("*3 +3 {2 __h   }5+3thh __h t_h _hh t_h _hh thh"); 
       8 * data.tick => w.wait;
     }
     if ( remove_last_beats  ){
       "*3 +3 {2 _hh   }5+3thh" => string seq;
...
//  stconvrev.connect(last $ ST , 29/* ir index */, 1 /* chans */, 0::ms /* pre delay*/, .001 * 3 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
  ...
  fun void EFFECT1   (){ 
    ...
    STCONVREV stconvrev;
    stconvrev.connect(last $ ST , 13/* ir index */, 1 /* chans */, 10::ms /* pre delay*/, .06 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
    while(1) {
           100::ms => now;
    }
...
autopan.connect(last $ ST, .9 /* span 0..1 */, data.tick * 8 / 1 /* period */, 0.95 /* phase 0..1 */ );       autopan $ ST @=>  last; 
  ...
  spork ~  EFFECT4();
    ...
    spork ~KICK("*4 k___ k___ k___ k___k___ k___ k___ k___",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ !3__    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!2!1   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aaa   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    spork ~KICK("*3  k__  k__  k__  k__  k__  k__  k__  k_k ",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ !5__    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1_   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aaa   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    spork ~KICK("*4 k___ k___ k___ k___k___ k___ k___ k_k_",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ ___    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 ___   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    spork ~KICK("*3  k__  k__  k__  k__  k__  k__  k__  ___ ",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ ___    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 !5!5!5   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aaa   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;

    spork ~KICK("*4 k___ k___ k___ k___k___ k___ k___ ____",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ ___    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 !3!2!1   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aaa   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    spork ~KICK("*3  k__  k__  k__  k__  k__  k__  k__  kk_ ",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ !1__ !1__ !1__ !5__    ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1!1 _!1_   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aa_   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    ...
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa aaa aaa aaa aaa   ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    spork ~KICK("*3  k__  k__  k__  k__  k__  ___  ___  ___ ",0,1.);
    spork ~ BASS0HF("*3 !1__ !1__ !1__ !1__ ___ ___ ___ ___     ",0,1.);
    spork ~ BASS0(" *3   _!1!1 _!1!1 _!1!1 _!1!1 ___ ___ ___ ___   ",0,1.);
    spork ~  BASS0_ATTACK ("*3     aaa aaa aaa aaa    ", 0.6 /* rate */,0, .16 /* g */); 
         8 * data.tick => w.wait;
    } 
fun void  CLAPS_8x8 (){ 
//    spork ~ TRIBAL_CUSTOM("*3 ___ _+4mo     ", 1 /* tomix */, 2.0 /* gain */);
//      2 * 8 * data.tick => w.wait;

    spork ~ TRIBAL_CUSTOM("*3 ___ _o_ ___ +4r__    ___ _zu ___ v__    ", 1 /* tomix */, 2.0 /* gain */);
      2 * 8 * data.tick => w.wait;
    spork ~ TRIBAL_CUSTOM("*3 aaa ", 1 /* tomix */, 2.0 /* gain */);
    spork ~ TRIBAL_CUSTOM("*3 ___ _+4mo ___ +4r__    ___ uz_ ___ t__    ", 1 /* tomix */, 2.0 /* gain */);
      2 * 8 * data.tick => w.wait;
    spork ~ TRIBAL_CUSTOM("*3 ___ _o_ ___ +4r__    ___ _zu     ", 1 /* tomix */, 2.0 /* gain */);
    spork ~ TRIBAL_CUSTOM("*3 ___ ___ ___ ___  ___ ___ ___ v__    ", 2 /* tomix */, 2.0 /* gain */);
      2 * 8 * data.tick => w.wait;
    spork ~ TRIBAL_CUSTOM("*3 aaa ", 1 /* tomix */, 2.0 /* gain */);
    spork ~ TRIBAL_CUSTOM("*3 ___ _+4mo ___ +4r__    ___ uz_    ", 1 /* tomix */, 2.0 /* gain */);
    spork ~ TRIBAL_CUSTOM("*3 ___ ___ ___ ___  ___ ___ ___ -2t+2t_    ", 2 /* tomix */, 1.6 /* gain */);
      2 * 8 * data.tick => w.wait;
} 
...
fun void  MELO  (){ 
  ...
  8 * data.tick => w.wait;
  spork ~ BW("*3 8__ ", 0/*n*/,29*100/*cut*/,2,1.0);
  8 * data.tick => w.wait;
  spork ~ BW("*3 }c 1!5_ ", 0/*n*/,29*100/*cut*/,1,0.8);
  8 * data.tick => w.wait;
  spork ~ BW("*3 f!f_ ", 0/*n*/,29*100/*cut*/,2,0.8);
  8 * data.tick => w.wait;
} 

fun void  FROGSx8(int n){ 
  for (0 => int i; i < n; i++) {
...
//spork ~ BW("*3 F_ ", 0/*n*/,29*100/*cut*/,1,6.0);
//spork ~ SYNTFROG ("{c{c{c *2 " + RAND.seq("8/1_,F/1_,__,__,__,__,f/8_,1/8_,F//1,1//F,B//8",8) , 2::ms, 8* data.tick, 3, 3.8);
//8 * data.tick => w.wait;
...
//  spork ~ TRIBAL_CUSTOM("*3 ___ ___ ___ __u ___ ___ ___ __v  ", 1 /* tomix */, 2.0 /* gain */);
...
//   spork ~   MELO (); 
     ...
     spork ~ ERAMPOD (10/*mixin*/,64*data.tick,":8:2 6////1"/*gseq*/,":8:2 1////4"/*odseq*/,6.8/*drive*/,0,2.4);
     spork ~ FROGSx8 (4); 
     spork ~   TRANCESNRHHx8 (8, 4); 
     spork ~ BEAT1_8x8();
     spork ~   CLAPS_8x8 (); 
     ...
     spork ~   MELO (); 
     spork ~ SYNTGLIDE("*3 }c 531 521 431 831 520 431" /* seq */, 122 /* Serum00 synt */, 59 * 100 /* lpf_f */, 12::ms /* glide dur */,64*data.tick,10,.49);
     spork ~ ERAMPOD (10/*mixin*/,64*data.tick,":8:2 1////A"/*gseq*/,":8:2 4////6"/*odseq*/,6.8/*drive*/,0,2.4);
     spork ~ FROGSx8 (4); 
     spork ~   TRANCESNRHHx8 (8, 4); 
     spork ~ BEAT1_8x8();
     spork ~   CLAPS_8x8 (); 
