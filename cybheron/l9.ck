...
"../_SAMPLES/wavetable/perso/psybass0.wav" => s.read;
  ...
  fun void on()  { }  fun void off() { }  fun void new_note(int idx)  { 0 * 0.01 =>p.phase; } 1 => own_adsr;
} 
...
stconvrevin.connect(last $ ST , ir/*UGen Input Reponse*/ , convrevin_dur /*rev_dur*/, 1.2 /* rev gain */  , 0.0 /* dry gain */  );  stconvrevin   $ ST @=>  last;
  ...
  STADSR stadsr;
  stadsr.set(1::ms /* Attack */, 6::ms /* Decay */, 1. /* Sustain */, -0.24/* Sustain dur of Relative release pos (float) */,  20::ms /* release */);
