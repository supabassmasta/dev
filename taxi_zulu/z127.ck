...
t.mix();
          ...
          // _ = pause , | = add note to current , * : = mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = shift base note , ! = force new note , # = sharp , ^ = bemol  
  "{c" + seq => t.seq;
  .5 *0.65 * data.master_gain => t.gain;
  //t.sync(4*data.tick);// t.element_sync();// 
  t.no_sync();//  t.full_sync(); // 1 * data.tick => t.the_end.fixed_end_dur;  // 16 * data.tick => t.extra_end;   //t.print(); //t.force_off_action();
              // t.mono() => dac;//  t.left() => dac.left; // t.right() => dac.right; // t.raw => dac;
              //t.set_adsrs(2::ms, 10::ms, .8, 40::ms);
...
//  spork ~   MODU (12, ":8:2 G/f",":8:2 G/1 "/*modf*/,":8:2 1"/*modg*/,2*1000/*cut*/,2,.63); 
  ...
  spork ~ BASS0_HPF(" *4 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1   ", ":4 M/ff/v"    );
    8 * data.tick => w.wait;
  spork ~KICK_HPF("*4k___ k___ k___ k___k___ k___ k___ " , ":4 v/ff/M");
  spork ~ BASS0_HPF(" *4 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1    ", ":4 v/ff/M"    );
    8 * data.tick => w.wait;
}  
