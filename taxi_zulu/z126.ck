...
fun void TRIBAL2(string seq, int tomix, float g) {
  local_delay => now;
...
//  spork ~   MODU (12, ":8:2 G/f",":8:2 G/1 "/*modf*/,":8:2 1"/*modg*/,2*1000/*cut*/,2,.63); 
 spork ~ TRIBAL2("*4 ___ ___j __j_ ____ l___  ___j __j_    ", 0 /* tomix */, 0.7 /* gain */);
 8 * data.tick => w.wait;
 spork ~ TRIBAL2("*4 ___ ___j __j_ ____ l___  ___j __j_    ", 0 /* tomix */, 0.7 /* gain */);
 8 * data.tick => w.wait;
// spork ~ TRIBAL_CUSTOM("*4 )2M___  ", 2 /* tomix */, 1.5 /* gain */);
// spork ~ SONATA   ();
// 8 * 6 * data.tick => w.wait;
// spork ~ SLIDENOISE(200/*fstart*/,1500/*fstop*/,14*data.tick/*dur*/,1.8/*width*/,2,.17); 
...
// 8 * 6 * data.tick => w.wait;
// spork ~ SLIDENOISE(200/*fstart*/,1500/*fstop*/,14*data.tick/*dur*/,1.8/*width*/,2,.17); 
//  spork ~   MODU (1222, ":8:2 P/f",":8:2 G/8 "/*modf*/,":8:2 1/y"/*modg*/,2*1000/*cut*/,2,.21); 
// 8 * 2 * data.tick => w.wait;
