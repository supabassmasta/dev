...
//  t.mix();//t.set_scale(data.scale.my_string); t.aeo(); // t.phr();// t.loc(); t.double_harmonic(); t.gypsy_minor();
  // _ = pause , | = add note to current , * : = mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = shift base note , ! = force new note , # = sharp , ^ = bemol  
  seq => t.seq;
  .5 *.40 * data.master_gain => t.gain;
  //t.sync(4*data.tick);// t.element_sync();// 
  t.no_sync();//  t.full_sync(); // 1 * data.tick => t.the_end.fixed_end_dur;  // 16 * data.tick => t.extra_end;   //t.print(); //t.force_off_action();
  // t.mono() => dac;//  t.left() => dac.left; // t.right() => dac.right; // t.raw => dac;
  //t.set_adsrs(2::ms, 10::ms, .2, 400::ms);
...
//  t.set_scale(data.scale.my_string);// t.aeo(); // t.phr();// t.loc(); t.double_harmonic(); t.gypsy_minor();
          // _ = pause , | = add note to current , * : = mutiply/divide bpm , <> = groove , +- = gain , () = pan , {} = shift base note , ! = force new note , # = sharp , ^ = bemol  
  "{c" + seq => t.seq;
  0.5 *.65 * data.master_gain => t.gain;
  //t.sync(4*data.tick);// t.element_sync();// 
  t.no_sync();//  t.full_sync(); // 1 * data.tick => t.the_end.fixed_end_dur;  // 16 * data.tick => t.extra_end;   //t.print(); //t.force_off_action();
              // t.mono() => dac;//  t.left() => dac.left; // t.right() => dac.right; // t.raw => dac;
              //t.set_adsrs(2::ms, 10::ms, .8, 40::ms);
...
fun void SONATA   (){ 
  spork ~   MODU (31, "*8  "+ RAND.seq("1_,1_,__,8_", 17) , "f", "6", 12 *1000, 3, .22); 
  8 * data.tick => w.wait;
  spork ~ SYNTGLIDE("*4 }c 8_5_ 1____ " /* seq */, 1111 /* Serum00 synt */,24*100/* lpf_f */, 5::ms /* glide dur */,2*data.tick,2,.34);
  8 * data.tick => w.wait;

  spork ~   MODU (25, "*8  "+ RAND.seq("1_,1_,__", 17) , "f", "4", 8 *1000, 3, .22); 
//  spork ~   MODU (31, "*8  "+ RAND.seq("1_,1_,__,8_", 17) , "f", "6", 12 *1000, 3, .25); 
  8 * data.tick => w.wait;

  spork ~ SYNTGLIDE("*4 }c A_1_A1___ " /* seq */, 1111 /* Serum00 synt */,24*100/* lpf_f */, 5::ms /* glide dur */,2*data.tick,2,.34);
  8 * data.tick => w.wait;
     
  spork ~   MODU (31, "*8  "+ RAND.seq("1_,1_,__,8_", 17) , "f", "6", 12 *1000, 3, .21); 
  8 * data.tick => w.wait;
  spork ~ SYNTGLIDE("*4 }c 3201 ____ " /* seq */, 1111 /* Serum00 synt */,24*100/* lpf_f */, 5::ms /* glide dur */,2*data.tick,2,.34);
  8 * data.tick => w.wait;

  spork ~   MODU (25, "*8  "+ RAND.seq("1_,1_,__", 17) , "f", "4", 8 *1000, 3, .23); 
//  spork ~   MODU (31, "*8  "+ RAND.seq("1_,1_,__,8_", 17) , "f", "6", 12 *1000, 3, .25); 
  8 * data.tick => w.wait;

  spork ~ SYNTGLIDE("*4 }c 123456789abcdef " /* seq */, 1111 /* Serum00 synt */,24*100/* lpf_f */, 5::ms /* glide dur */,2*data.tick,2,.34);
  8 * data.tick => w.wait;
 } 
//SONATA   ();
...
//   spork ~ BASS0(" *4   __!3!3 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!2!2 __!1!1   ");
//   spork ~  BASS0_ATTACK ("*4     aaaa aaaa aaaa aaaa aaaa aaaa aaaa aaaa  ", 0.7 /* rate */, .16 /* g */); 
//  spork ~   MODU (12, ":8:2 G/f",":8:2 G/1 "/*modf*/,":8:2 1"/*modg*/,2*1000/*cut*/,2,.63); 

// spork ~KICK_LPF("*4k___ k___ k___ k___k___ k___ k___  k___ k___" , ":4 f//M");
//  spork ~ BASS0_LPF(" *4 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1   __!1!1 __!1!1   ", ":4f//M "    );
//    8 * data.tick => w.wait;
  spork ~KICK_LPF("*4k___ k___ k___ k___ k___ k___ k___ k___  
                     k___ k___ k___ k___ k___ k___ k___ k___    
                     k___ k___ k___ k___ k___ k___ k___ k___
                     k___ k___ k___ k___ k___ k___ k___ k___  " , ":8:4 M//f");
//  spork ~ BASS0_LPF(" *4 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1 __!1!1    ", ":8 M//f"    );
