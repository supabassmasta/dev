...
TONE t;
t.reg(PAD2 s0);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// t.dor();// t.aeo(); // t.phr();// t.loc();
t.reg(PAD2 s1);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// t.dor();// t.aeo(); // t.phr();// t.loc();
t.reg(PAD2 s2);  //data.tick * 9 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// 
...
STSYNCLPF stsynclpf;
stsynclpf.freq(200 /* Base */, 7 * 100 /* Variable */, 2. /* Q */);
