...
stechohpf.stdelay.connect( last $ ST, 1.08/* gain */ , 1. / 8. * data.tick /* delay */ );

stechohpf.stsynchpf.freq(6 * 1000 /* Base */, 4 * 1000 /* Variable */, 1.4 /* Q */);
...
stechohpf.stadsr.set(0::ms /* Attack */, 6::ms /* Decay */, 1.0 /* Sustain */, 8 * data.tick /* Sustain dur */, 4 * data.tick /* release */);
