...
stsynclpfx0.freq(11 * 10 /* Base */, 118 * 10 /* Variable */, 1. /* Q */);
stsynclpfx0.adsr_set(.0002 /* Relative Attack */, 29*  .001/* Relative Decay */, 0.5 /* Sustain */, .4 /* Relative Sustain dur */, 0.1 /* Relative release */);
...
stloshelf0.connect(last $ ST , 4 * 100 /* freq */ , 1.0 /* Q */ , 1 /* order */, 1 /* channels */, 0.3 /* Gain */ );       stloshelf0 $ ST @=>  last;   
.7 => stloshelf0.gain;
