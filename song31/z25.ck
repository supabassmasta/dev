...
while(1) {
spork ~  RAND("*4 +3 }c" /* Seq begining */ , 6 /* Nb rand elements */ ); 
4 * data.tick =>  w.wait; 
...
spork ~  RAND("*4 }c}c" /* Seq begining */ , 6 /* Nb rand elements */ ); 
spork ~  SLIDE(2000 /* fstart */, 50 /* fstop */, 2* data.tick /* dur */, .5 /* width */, .03 /* gain */); 
4 * data.tick =>  w.wait; 

spork ~   FROG(4 /* fstart */, 15 /* fstop */, 36 * 100 /* lpfstart */, 4 * 100 /* lpfstop */, 1* data.tick /* dur */, .3 /* gain */);
4 * data.tick =>  w.wait; 
}
