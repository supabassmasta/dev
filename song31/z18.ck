...
stautobpfx0.connect(last $ ST ,  stautobpfx0_fact, 1.0 /* Q */, 6 * 100 /* freq base */, 37 * 100 /* freq var */, data.tick * 16 / 2 /* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautobpfx0 $ ST @=>  last;  
