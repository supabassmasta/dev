...
s0.add(65 /* synt nb */ , 0.4 /* GAIN */, 1.0 /* in freq gain */,  1::ms /* attack */, 0 * data.tick /* decay */, 1. /* sustain */, .5* data.tick /* release */ );
...
stautolpfx0.connect(last $ ST ,  stautolpfx0_fact, 1.3 /* Q */, 5 * 100 /* freq base */, 26 * 100 /* freq var */, data.tick * 16 / 2 /* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautolpfx0 $ ST @=>  last;  
