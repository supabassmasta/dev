LONG_WAV l;
"../_SAMPLES/la boule/la boule loop1+Full djembe1.wav" => l.read;
0.4 * data.master_gain => l.buf.gain;
0 => l.update_ref_time;
l.AttackRelease(0::ms, 10::ms);
l.start(16 * data.tick /* sync */ , 0 * data.tick  /* offset */ , 32 * data.tick /* loop (0::ms == disable) */ , 16 * data.tick /* END sync */); l $ ST @=> ST @ last;  
