...
//     
//     STREC strec;
//     strec.connect(last $ ST, 16*data.tick, "../_SAMPLES/Aborigines/pads_break.wav", 4 * data.tick /* sync_dur, 0 == sync on full dur */, 0 /* no sync */ ); strec $ ST @=>  last;  
...
LONG_WAV l;
"../_SAMPLES/Aborigines/pads_break.wav" => l.read;
