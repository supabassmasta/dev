...
//      //     
//           STREC strec;
//           strec.connect(last $ ST, 40*data.tick, "../_SAMPLES/Aborigines/pads_long_break.wav", 4 * data.tick /* sync_dur, 0 == sync on full dur */, 0 /* no sync */ ); strec $ ST @=>  last;  
//      
//      
//      
//      //////////////////////////////////////////////////////////////////////////
   ...
   LONG_WAV l;
   "../_SAMPLES/Aborigines/pads_long_break.wav" => l.read;
   1.0 * data.master_gain => l.buf.gain;
   0 => l.update_ref_time;
   l.AttackRelease(0::ms, 2000::ms);
