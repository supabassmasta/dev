...
STADSRC stadsrc;
stadsrc.connect(last, HW.launchpad.keys[16*1 + 6] /* pad 1:1 */ /* controler */, 2::ms /* attack */, 2::ms /* release */, 1 /* default_on */, 1  /* toggle */); stadsrc $ ST @=> last; 
...
while(1) {
  ...
  play( 8.0*d, d/4, 1. , 2::ms, 2::ms); /// 
   ...
   play( 3*d, d/4, 1. , 2::ms, 2::ms); /// Hi
   d/3 => now;
   play( 5.5*d, d/4, 1. , 2::ms, 2::ms); /// Tu
   d/7 => now;
   play( 6.5*d, d/4, 1. , 2::ms, 2::ms); 
   d/7 => now;
   play( 5.5*d, d/4, 1. , 2::ms, 2::ms);
   d/7 => now;
   play( 3*d, d/8, 1. , 2::ms, 2::ms); /// Hi
   play( 3*d, d/8, 1. , 2::ms, 2::ms); /// Hi
   play( 3*d, d/8, 1. , 2::ms, 2::ms); /// Hi
   play( 3*d, d/8, 1. , 2::ms, 2::ms); /// Hi
   d/3 => now;
   play( 2*d, d/4, 1. , 2::ms, 2::ms); // Hee
   d/3 => now;
   play( 5.5*d, d/4, 1. , 2::ms, 2::ms); /// Tu
   d/7 => now;
