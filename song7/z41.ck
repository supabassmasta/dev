...
t.adsr[1].set(1::ms, 10::ms, .01, 600::ms);
t.adsr[1].setCurves(2.0, 3.0, 1.0); // curves: > 1 = Attack concave, other convexe  < 1 Attack convexe others concave
t.go(); 

t.mono() => GVerb gverb0  => dac;
80 => gverb0.roomsize;        // roomsize: (float) [1.0 - 300.0], default 30.0   
9::second => gverb0.revtime;   // revtime: (dur), default 5::second
