class synt0 extends SYNT{
		...
		inlet => Gain in => ibniz s => LPF lpf =>  outlet;		
				...
				fun void f1 (){ 
					while(1) {
						//	<<<"POT",LPD8.pot[0][0]>>>; 
						LPD8.pot[0][0]  / 127.  => s.gain;
						Std.mtof(LPD8.pot[0][1]) => lpf.freq;
						LPD8.pot[0][2] * 12. / 127. + 1. => lpf.Q;
...
//"*8 {c {c 11" => t.seq;
" {c {c 11__57_1AC_B 7531_ 8///1" => t.seq;
.9 => t.gain;
...
STECHO ech;
ech.connect(t $ ST , 4 * data.tick / 4, .6); 
