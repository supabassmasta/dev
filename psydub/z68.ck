...
//				1 => hpf.Q;
			...
			1. => opin[i].gain;
			adsrop[i].set(10::ms, 20::ms, .7 , 200::ms);
			1 => adsrop[i].gain;
			i++;
			...
			adsrop[i].set(10::ms, 90::ms, .001 , 200::ms);
			40 * 1 => adsrop[i].gain;
			i++;

			//---------------------
			opin[i] => ABSaturator sat => adsrop[i] => opout[i];
			1./8. +0.0 => opin[i].gain;
			adsrop[i].set(1::ms, 180::ms, .01 , 1800::ms);
			8 => adsrop[i].gain;
			i++;
10 => sat.drive;
0 => sat.dcOffset;
...
"*2 {c 1_1_ c//1_ A!A__ 1!5!3!7_" => t.seq;
