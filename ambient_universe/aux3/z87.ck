...
POLY synta; 
l.reg(synta);
synta.reg(synt0 s0);  synta.a[0].set(30::ms, 300::ms, .7, 200::ms);
synta.reg(synt0 s1);  synta.a[1].set(30::ms, 300::ms, .7, 200::ms);
synta.reg(synt0 s2);  synta.a[2].set(30::ms, 300::ms, .7, 200::ms);
synta.reg(synt0 s3);  synta.a[3].set(30::ms, 300::ms, .7, 200::ms);
