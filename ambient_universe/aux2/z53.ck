...
STREC strec;
strec.connect(last $ ST, 32*data.tick, "../../_SAMPLES/ambient_universe/amb3.wav", 0 * data.tick /* sync_dur, 0 == sync on full dur */, 0 /* no sync */ ); strec $ ST @=>  last;  
