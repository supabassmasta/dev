...
while(1) { /********************************************************/
  ...
  spork ~ HAT("*2}5 hh_h __j_ __hj __h_ j_*8h_h_hhhh:8_hh_h __j_ __hj __h_ j_*8hhhh_h_h:8_");
//  spork ~   DNB  ("*2 __hh ___s hsh_ _J_J hssJ hs_s hshs shh_ __ss", ":2 }c z/ff/zz/f", .6); 
  spork ~   DUB  ( "*2____ s_ ____ ___*2-3aa ", 0,  1.5); 
  spork ~   DUB  ( "*2____ ____ ____ u_ ", 2,  0.7); 

8 * data.tick => w.wait;
  spork ~   DUB  ( "*2____ s_ ___*2_b _ ___", 1,  .9); 
  spork ~   DUB  ( "*2____ ____ ____ t_ ", 2,  1.3); 
8 * data.tick => w.wait;
