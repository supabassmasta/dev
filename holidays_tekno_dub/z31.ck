...
while(1) { /********************************************************/
    spork ~ MEGAMOD (133  /*137*/ , 23 /* nmod */, "*4 }c 4_" ,":8 0//11//0 " /* modf */, ":8 6//bb//6" /*modg*/, ":8 4//88//4" /* g curve */, 32 * data.tick, 1.2)  ;
 
32 * data.tick => w.wait;
    spork ~ MEGAMOD (133  /*137*/ , 23 /* nmod */, "*4 }c 4_" ,":8 1//00//0 " /* modf */, ":8 b//66//b" /*modg*/, ":8 4//88//4" /* g curve */, 32 * data.tick, 0.5)  ;
32 * data.tick => w.wait;
