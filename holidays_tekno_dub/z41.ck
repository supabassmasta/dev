...
stautolpfx0.connect(last $ ST ,  stautolpfx0_fact, 1.2 /* Q */, 5 * 100 /* freq base */, 8 * 100 /* freq var */, data.tick * 12 / 2 /* modulation period */, 2 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautolpfx0 $ ST @=>  last;  
