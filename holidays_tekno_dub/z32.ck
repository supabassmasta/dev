...
stsynclpfx0.freq(8 * 10 /* Base */, 7 * 100 /* Variable */, 1.5 /* Q */);
stsynclpfx0.adsr_set(.1 /* Relative Attack */, .6/* Relative Decay */, 0.4 /* Sustain */, .3 /* Relative Sustain dur */, 0.5 /* Relative release */);
...
stautoresx0.connect(last $ ST ,  stautoresx0_fact, 1.0 /* Q */, 8 * 100 /* freq base */, 18 * 100 /* freq var */, data.tick * 7 / 2 /* modulation period */, 1 /* order */, 1 /* channels */ , 1::ms /* update period */ );       stautoresx0 $ ST @=>  last;  
...
STGVERB stgverb;
stgverb.connect(last $ ST, .12 /* mix */, 7 * 10. /* room size */, 4::second /* rev time */, 0.2 /* early */ , 0.6 /* tail */ ); stgverb $ ST @=>  last; 
...
12 * data.tick => w.wait;
    spork ~ MEGAMOD (72  /*137*/ , 23 /* nmod */, "*6  }c " + RAND.char("4_1_418b//", 16) ,"*8 180  " /* modf */, "F" /*modg*/, "8" /* g curve */, 4 * data.tick, 0.2)  ;
4 * data.tick => w.wait;
    spork ~ MEGAMOD (39  /*137*/ , 23 /* nmod */, "*4  }c " + RAND.char("41418b//", 16) ,"*8 1853B1  " /* modf */, "F" /*modg*/, "8" /* g curve */, 4 * data.tick, 0.2)  ;
16 * data.tick => w.wait;
    spork ~ MEGAMOD (136  /*137*/ , 23 /* nmod */, "*8 }c }c " + RAND.char("41418b", 16) ,"*8 1853B1  " /* modf */, "F" /*modg*/, "8" /* g curve */, 4 * data.tick, 0.7)  ;
16 * data.tick => w.wait;
