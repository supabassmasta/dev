...
while( true )
{
    ...
    */
    ...
    .5::second => now;
	  ...
	  1 =>  preset; bwg.controlChange(16, preset);  <<<"bwg.controlChange( 16, ", preset,"/* preset */);">>>;
    // go
    .8 => bwg.noteOn;
    ...
    .5::second => now;
	  ...
	  2 =>  preset; bwg.controlChange(16, preset);  <<<"bwg.controlChange( 16, ", preset,"/* preset */);">>>;
    // go
    .8 => bwg.noteOn;
    ...
    .5::second => now;
	  ...
	  3 =>  preset; bwg.controlChange(16, preset);  <<<"bwg.controlChange( 16, ", preset,"/* preset */);">>>;
    // go
    .8 => bwg.noteOn;
