class synt0 extends SYNT{
    ...
    1. => opin[i].gain;
    adsrop[i].set(1::ms, 200::ms, .00001 , 200::ms);
...
//"}c}c *4
// 1__811_8 333_33_a 5_5_____ 4_4444___
// 1__811__ 4__4__44 1_1__1__ 88881818_
//" => t.seq;
"}c}c *4
   1358_428 
}3 13_81_58 
...
STFILTERMOD fmod;
fmod.connect( t , "ResonZ" /* "HPF" "BPF" BRF" "ResonZ" */, 4 /* Q */, 1000 /* f_base */ , 800  /* f_var */, 1::second / (2 * data.tick) /* f_mod */); 

STECHO ech;
ech.connect(fmod $ ST , data.tick * 1 / 1 , .5); 

STAUTOPAN autopan;
autopan.connect(ech $ ST, .9 /* span 0..1 */, 8*data.tick /* period */, 0.95 /* phase 0..1 */ );  
