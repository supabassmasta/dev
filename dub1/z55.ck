...
"}c 
_1|3|5|8 _1|3|5|8 _5|7|9|c _3|5|7|a  
_1|3|5|8 _1|3|5|8 _4|6|8|b _7|a|c|f
...
STECHO ech2;
ech2.connect(ech $ ST , 3 * data.tick/4  , .8); 


STAUTOPAN autopan;
autopan.connect(ech2 $ ST, -.6 /* span 0..1 */, 8*data.tick /* period */, 0.5 /* phase 0..1 */ );  
