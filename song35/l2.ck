...
STDISTO stdisto;
stdisto.connect(last $ ST,3/*mode*/,3.0/*gain in*/,1/*dc blcok*/,1/*chan*/,0.2/*gain*/);       stdisto $ ST @=>  last;  
.02 => stdisto.distl.bias=> stdisto.distr.bias;
.5 =>  stdisto.distl.warmth=>  stdisto.distr.warmth;  
