...
fun void EFFECT1   (){ 
  ...
  STGVERB stgverb;
  stgverb.connect(last $ ST, .10 /* mix */, 6 * 10. /* room size */, 4::second /* rev time */, 0.2 /* early */ , 0.6 /* tail */ ); stgverb $ ST @=>  last; 
} 
EFFECT1();
...
while(1) { /********************************************************/
  ...
  spork ~ SYNT0(" :4 1 __", 34, mixer + 1, .8);
  spork ~ SYNT0(" :4 1 __", 35, mixer + 1, 1.2);
