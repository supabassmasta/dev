...
kik.addFreqPoint (100.0, 40::ms);
kik.addFreqPoint (35.0, 13 * 10::ms);

kik.addGainPoint (0.6, 2::ms);
kik.addGainPoint (0.3, 10::ms);
kik.addGainPoint (1.0, 20::ms);
kik.addGainPoint (1.0, 138::ms);
...
STDUCKMASTER duckm;
duckm.connect(last $ ST, 9. /* In Gain */, 48 * .01 /* Tresh */, .2 /* Slope */, 15::ms /* Attack */, 15::ms /* Release */ );      duckm $ ST @=>  last; 
