...
"M_T_MMT" => s.seq;
3.9 * data.master_gain => s.gain; // s.gain("s", .2); // for single wav 
...
STCONVREV stconvrev;
stconvrev.connect(last $ ST , 3/* ir index */, 2 /* chans */, 0::ms /* pre delay*/, .2 /* rev gain */  , 0.9 /* dry gain */  );       stconvrev $ ST @=>  last;  
