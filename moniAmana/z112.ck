...
"*4 
s|k__s k_s_ k_ss ks__
s|k__s k_s_ k_ss ksk_
s|k__s k_s_ k_ss k_s_
s|k__s k_s_ k_ss k|s_s_
...
//// SUBWAV ////
SEQ s2; SET_WAV.TRANCE(s2); s.add_subwav("k", s2.wav["k"]);  s.gain_subwav("k", 0, .4);
s.go();     s $ ST @=> ST @ last; 

STOVERDRIVE stod;
stod.connect(last $ ST, 2.1 /* drive 1 == no drive, > 1 == drive */ ); stod $ ST @=> last; 
