...
TONE t;
t.reg(SERUM0 s0); s0.config(15, 1);  //data.tick * 8 => t.max; //60::ms => t.glide;  // t.lyd(); // t.ion(); // t.mix();// t.dor();// t.aeo(); // t.phr();// t.loc();
...
STGAINC gainc;
gainc.connect(last $ ST , HW.lpd8.potar[1][1] /* gain */  , 0.6 /* static gain */  );       gainc $ ST @=>  last; 
