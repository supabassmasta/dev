class synt0 extends SYNT{
  ...
  // Params
  padsr.set(data.tick / 4 , data.tick / 4 , 1. , data.tick / 8);
  padsr.setCurves(.6, 2.0, .5);
  3 => filter.Q;
  48 => base.next;
...
"{c *6 *2 ____________ ______3_3_3_
 }c         ____________ 5_5_5_0_0_0_ 
 {c         ____________ 8_7_5_3_1_0_ 
 }c         ____________ 6_6_6_0_0_0_ 
" => t.seq;
.9 => t.gain;
